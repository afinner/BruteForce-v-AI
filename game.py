...
class Game:
    ...
    def __init__(self, agent, teacher=None, gridSize=3):
        self.agent = agent
        self.teacher = teacher
        self.gridSize = gridSize
        # initialize the game board
        #self.board = [['_', '_', '_'], ['_', '_', '_'], ['_', '_', '_']]
        self.board = [['_' for x in range(0,gridSize)] for x in range(0,gridSize)]
        ...
        if self.teacher is not None:
            ...
            while True:
                ...
                try:
                    ...
                    continue
                if row not in range(self.gridSize) or col not in range(self.gridSize) or not self.board[row][col] == '_':
